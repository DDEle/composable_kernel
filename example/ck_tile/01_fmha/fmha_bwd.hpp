...
template <class T>
concept fmha_bwd_dq_dk_dv_traits_c = T::is_fmha_bwd_dq_dk_dv_traits_;
...
template <class T>
concept fmha_bwd_dot_do_o_traits_c = T::is_fmha_bwd_dot_do_o_traits_;
...
template <class T>
concept fmha_bwd_convert_dq_traits_c = T::is_fmha_bwd_convert_dq_traits_;
...
consteval auto get_fmha_bwd_tile_size()
{
...
template <class T>
concept fmha_bwd_kernal_group_traits_c = T::is_fmha_bwd_kernal_group_traits_;
