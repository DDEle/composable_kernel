...
struct WarpGemmAttributeMfmaTransposedCDistribution
{
    ...
    using AWarpDstrEncoding = WarpGemmAttributeMfma<Impl, AttrNumAccess>::BWarpDstrEncoding;
    using BWarpDstrEncoding = WarpGemmAttributeMfma<Impl, AttrNumAccess>::AWarpDstrEncoding;
...
struct WarpGemmAttributeMfmaIterateKAndTransposedCDistribution
{
    ...
    using AWarpDstrEncoding =
        WarpGemmAttributeMfmaIterateK<Impl, kKIter, AttrNumAccess>::BWarpDstrEncoding;
    using BWarpDstrEncoding =
        WarpGemmAttributeMfmaIterateK<Impl, kKIter, AttrNumAccess>::AWarpDstrEncoding;
    using CWarpDstrEncoding = decltype(get_cwarp_dstr_encoding());
