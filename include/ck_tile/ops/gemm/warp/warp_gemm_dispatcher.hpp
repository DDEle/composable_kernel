...
template<> struct Dispatcher<fp8_t, fp8_t, float, 16, 16, 128, false> { using Type = WarpGemmMfma_f32_16x16x128_fp8_fp8<>; };
template<> struct Dispatcher<fp8_t, bf8_t, float, 16, 16, 128, false> { using Type = WarpGemmMfma_f32_16x16x128_fp8_bf8<>; };
template<> struct Dispatcher<bf8_t, fp8_t, float, 16, 16, 128, false> { using Type = WarpGemmMfma_f32_16x16x128_bf8_fp8<>; };
template<> struct Dispatcher<bf8_t, bf8_t, float, 16, 16, 128, false> { using Type = WarpGemmMfma_f32_16x16x128_bf8_bf8<>; };
template<> struct Dispatcher<fp8_t, fp8_t, float, 16, 16, 128,  true> { using Type = WarpGemmMfma_f32_16x16x128_fp8_fp8_CTransposed<>; };
template<> struct Dispatcher<fp8_t, bf8_t, float, 16, 16, 128,  true> { using Type = WarpGemmMfma_f32_16x16x128_fp8_bf8_CTransposed<>; };
template<> struct Dispatcher<bf8_t, fp8_t, float, 16, 16, 128,  true> { using Type = WarpGemmMfma_f32_16x16x128_bf8_fp8_CTransposed<>; };
template<> struct Dispatcher<bf8_t, bf8_t, float, 16, 16, 128,  true> { using Type = WarpGemmMfma_f32_16x16x128_bf8_bf8_CTransposed<>; };
...
template<> struct Dispatcher<fp8_t, fp8_t, float, 16, 16,  128, false, false, false, EQuad> { using Type = WarpGemmMfma_f32_16x16x128_fp8_fp8<EQuad>; };
template<> struct Dispatcher<fp8_t, bf8_t, float, 16, 16,  128, false, false, false, EQuad> { using Type = WarpGemmMfma_f32_16x16x128_fp8_bf8<EQuad>; };
template<> struct Dispatcher<bf8_t, fp8_t, float, 16, 16,  128, false, false, false, EQuad> { using Type = WarpGemmMfma_f32_16x16x128_bf8_fp8<EQuad>; };
template<> struct Dispatcher<bf8_t, bf8_t, float, 16, 16,  128, false, false, false, EQuad> { using Type = WarpGemmMfma_f32_16x16x128_bf8_bf8<EQuad>; };
