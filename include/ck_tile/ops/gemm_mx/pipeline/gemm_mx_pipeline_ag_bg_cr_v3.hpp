...
struct BaseGemmMxPipelineAgBgCrV1
{
...
template <typename Problem, typename PipelinePolicy = UniversalGemmMxPipelineAgBgCrPolicy>
struct GemmMxPipelineAgBgCrV1 : public BaseGemmMxPipelineAgBgCrV1<Problem>
{
    using Base           = BaseGemmMxPipelineAgBgCrV1<Problem>;
    ...
    {
        // clang-format off
        return concat('_', "pipeline_AgBgCrV1", 
