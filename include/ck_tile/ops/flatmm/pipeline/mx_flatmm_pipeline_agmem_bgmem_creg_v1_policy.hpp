...
struct MXF4FlatmmPipelineAgBgCrPolicy : UniversalFlatmmPipelineAgBgCrPolicy
{
    ...
    template <typename Problem>
    CK_TILE_HOST_DEVICE static constexpr auto MakeMXFP4_BFlatBytesDramTileDistribution()
    {
        using TileShape         = typename Problem::BlockGemmShape;
        using BDataType         = remove_cvref_t<typename Problem::BDataType>;
    ...
    MakeMXFP4_BFlatBytesDramWindow(const WindowTmp& window_tmp)
    {
        ...
        return make_tile_window(
            ...
            MakeMXFP4_BFlatBytesDramTileDistribution<Problem>());
    }
