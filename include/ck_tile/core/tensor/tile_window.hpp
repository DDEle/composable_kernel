...
inline constexpr bool
    has_pre_compute_warp_coords_v<T, std::void_t<decltype(T::has_pre_compute_warp_coords)>> =
        T::has_pre_compute_warp_coords;
          ...
          StaticTileDistribution_>
{
    ...
    template <typename NewReplacementPartitionIndex = sequence<-1, -1>>
...
template <typename TensorView_,
          ...
          typename StaticTileDistribution_,
          index_t NumCoord = 1,
          typename Traits  = std::false_type>
CK_TILE_DEVICE constexpr auto
